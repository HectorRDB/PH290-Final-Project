...
We load the data that we want (i.e the binomial data that will serve to produce the simulation) and the scripts. The main function we care about is __simulate_outcome()__.
...
The simulation returns the simulated outcome $y$ as well as the $covariates$ matrix used to do the simulation.
